(function(){
  ...
  var OV_STATUS = {
    'Ótimo':      {accent:'#2563eb', badgeBg:'#eff6ff', badgeText:'#1e40af', icon:'★', barColor:'#3b82f6'},
    'Bom':        {accent:'#16a34a', badgeBg:'#dcfce7', badgeText:'#166534', icon:'↗', barColor:'#22c55e'},
    'Suficiente': {accent:'#ea580c', badgeBg:'#ffedd5', badgeText:'#9a3412', icon:'→', barColor:'#f97316'},
    'Regular':    {accent:'#dc2626', badgeBg:'#fee2e2', badgeText:'#991b1b', icon:'↘', barColor:'#ef4444'}
  };
