(function(){
  ...
  var OV_STATUS = {
    'Ótimo':      {accent:'#2563eb', badgeBg:'#eff6ff', badgeText:'#1e40af', icon:'★', barColor:'#60a5fa'},
    'Bom':        {accent:'#16a34a', badgeBg:'#dcfce7', badgeText:'#166534', icon:'↗', barColor:'#4ade80'},
    'Suficiente': {accent:'#ea580c', badgeBg:'#ffedd5', badgeText:'#9a3412', icon:'→', barColor:'#fb923c'},
    'Regular':    {accent:'#dc2626', badgeBg:'#fee2e2', badgeText:'#991b1b', icon:'↘', barColor:'#f87171'}
  };
